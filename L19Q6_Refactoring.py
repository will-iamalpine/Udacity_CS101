...
print table
print 'original', hashtable_lookup(table, 'Python'),'\n'
...
table_dict['Python'] = 'Monty'
table_dict['CLU'] = 'Barbara Liskov'
table_dict['JavaScript'] = 'Brendan Eich'
table_dict['Python'] = 'Guido van Rossum'
print table_dict
print table_dict['Python']
